#https://stackoverflow.com/questions/47641111/how-to-measure-distance-between-2-points-in-opencv-pixel-to-cm
import cv2
import numpy as np
...
while (1):
    ...
    (_, contours, hierarchy) = cv2.findContours(blue, cv2.RETR_TREE,
                                                cv2.CHAIN_APPROX_SIMPLE)  # Encuentra los contornos de los objetos que se ven en el filtro
